...
static NSString *hasLaunchedKey = @"hasLaunched";
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if (!hasLaunched) {
        ...
        for (NSString *name in students) {
            Student *student = [[CohortController sharedInstance] createStudentInCohort:cohort];
            student.name = name;
        }
    ...
    self.window.rootViewController = [[UINavigationController alloc] initWithRootViewController:[CohortListViewController new]];
